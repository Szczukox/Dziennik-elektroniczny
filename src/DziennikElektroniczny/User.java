...
public class User implements Serializable {
    ...
    public void setPasswordExpired(String passwordExpired) {
        String oldPasswordExpired = this.passwordExpired;
        this.passwordExpired = passwordExpired;
        changeSupport.firePropertyChange("passwordExpired", oldPasswordExpired, passwordExpired);
    }
    ...
    public void setIsRole(String isRole) {
        String oldIsRole = this.isRole;
        this.isRole = isRole;
        changeSupport.firePropertyChange("isRole", oldIsRole, isRole);
    }
    ...
    public void setDefaultRole(String defaultRole) {
        String oldDefaultRole = this.defaultRole;
        this.defaultRole = defaultRole;
        changeSupport.firePropertyChange("defaultRole", oldDefaultRole, defaultRole);
    }
    ...
    public void setMaxStatementTime(BigDecimal maxStatementTime) {
        BigDecimal oldMaxStatementTime = this.maxStatementTime;
        this.maxStatementTime = maxStatementTime;
        changeSupport.firePropertyChange("maxStatementTime", oldMaxStatementTime, maxStatementTime);
    }
    ...
    public String toString() {
        return "DziennikElektroniczny.User[ userPK=" + userPK + " ]";
    }
